...
const Footer = () => {
  ...
  <div class="absolute top-0 left-0 h-full w-full overflow-hidden">
    <div class="absolute h-full w-full top-0 left-0 bg-green-500 transform -rotate-45 -translate-x-2/3"></div>
  </div>
      ...
      <div className="w-11/12 mx-auto flex flex-wrap py-20">
        ...
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
          ...
          <div className="flex">
            <Link
              to="#"
              className="bg-blue-600 text-white rounded-full h-8 w-8 flex items-center justify-center mr-4"
            >
              <Facebook />
            </Link>
            <Link
              to="#"
              className="bg-pink-600 text-white rounded-full h-8 w-8 flex items-center justify-center mr-4"
            >
              <Instagram />
            </Link>
            <Link
              to="#"
              className="bg-blue-400 text-white rounded-full h-8 w-8 flex items-center justify-center mr-4"
            >
              <Twitter />
            </Link>
            <Link
              to="#"
              className="bg-red-600 text-white rounded-full h-8 w-8 flex items-center justify-center"
            >
              <Pinterest />
            </Link>
          </div>
