    ...
    <div className="w-full">
      ...
      <section className="w-11/12 mx-auto flex flex-col gap-6  ">
        ...
        <section className="p-10 flex flex-row justify-between w-full">
          ...
          <div className="w-[25%] p-0 px-24 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-black font-normal text-normal rounded-md border-custom-btn-green border-solid border-2 w-fit p-2 ">{8 * quantity} yards</p>
            </div>
            <div>
                {alreadyInCart ? (
